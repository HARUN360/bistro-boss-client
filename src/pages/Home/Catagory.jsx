...
const Catagory = () => {
    return (
        ...
        >
            <SwiperSlide>
                <img src={slide1} alt="" />
                <h3 className='text-4xl uppercase text-center -mt-20 text-white font-semibold'>Salads</h3>
            </SwiperSlide>
            <SwiperSlide>
                <img src={slide2} alt="" />
                <h3 className='text-4xl uppercase text-center -mt-20 text-white font-semibold'>Pizza</h3>
            </SwiperSlide>
            <SwiperSlide>
                <img src={slide3} alt="" />
